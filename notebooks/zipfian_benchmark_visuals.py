...
mode_y_offsets = {
    ...
    'rpc_request_json': -30  # Offset down most (best performer, lowest on chart)
}
...
# Position text on the FAR RIGHT of chart (beyond all bars at x=3.5)
ax.text(3.5, 79, '← 79ms target', va='center', ha='left', fontsize=10, 
