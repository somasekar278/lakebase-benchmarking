...
# -*- coding: utf-8 -*-
"""
Realistic Zipfian Feature Serving Benchmark V5.3 (Multi-Entity)
...
# COMMAND ----------
# MAGIC %md
# MAGIC # 🎯 Realistic Zipfian Feature Serving Benchmark V5.3 (Multi-Entity)
# MAGIC
...
def persist_results(conn, hot_pct, results):
    ...
    with conn.cursor() as cur:
        ...
        """, (
            ...
            f"Multi-entity Zipfian benchmark V5.3 (mode: {results['fetch_mode']}, workers: {results.get('parallel_workers', 'N/A')})"
        ))
    conn.commit()
...
# COMMAND ----------
print("\n" + "="*80)
print("🚀 STARTING MULTI-ENTITY ZIPFIAN BENCHMARK V5.3")
print("="*80)
print()
